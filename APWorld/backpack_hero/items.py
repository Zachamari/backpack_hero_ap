...
ITEM_NAME_TO_ID_AND_CLASSIFICATION = {
    ...
    "Copy Star": [71 + ITEM_OFFSET, ItemClassification.useful, ["Dungeon Items", "Shuriken", "Weapons", "Uncommon Items"]],
    "Column Chain Star": [72 + ITEM_OFFSET, ItemClassification.progression_deprioritized, ["Dungeon Items", "Shuriken", "Weapons", "Rare Items"]],
